...
public class Benchmark {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Bag: Throughput is " + (iters*threadCount) / ((totalTime1/threadCount)*0.001) + "ops/s");
        System.out.println("Bag: Average time per thread is " + totalTime1 / threadCount + "ms");

        System.out.println("List: Throughput is " + (iters*threadCount) / ((totalTime2/threadCount)*0.001) + "ops/s");
